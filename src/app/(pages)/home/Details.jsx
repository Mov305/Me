      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:py-16 lg:px-8">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3 lg:gap-16">
          ...
          <div className="lg:pt-14 lg:col-span-2">
            ...
            <div className="flex flex-col lg:flex-row gap-4 mt-4 lg:justify-center lg:items-center">
              <div>
                    ...
                    >
                      <div>
                        <div className="flex items-center">
                          ...
                          <h3 className=" text-lg md:text-xl uppercase font-bold">{job.title}</h3>
                          <h4 className="text-gray-200 ml-4">
              ...
              <span className="w-[1px] rounded-full h-40 hidden lg:block gradient_btn opacity-50"></span>
              <div>
                <h2 className="text-3xl font-bold sm:text-4xl mt-8 gradient_title">Education</h2>
                <div className="mt-4 flex gap-4 flex-col w-full">
                  {education.map((job) => (
                    <motion.div
                      variants={nameVariants}
                    ...
                    >
                      <div>
                        <div className="flex items-center">
                          <div className="w-2 h-2 rounded-full bg-indigo-500 mr-2"></div>
                          <h3 className="text-xl md:text-xl uppercase font-bold">{job.title}</h3>
                        </div>
                        <h4 className="text-gray-200 ml-4">{job.company}</h4>
                      </div>
                      <div className="ml-4">
